...
"""
kdl-portfolio documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'kdl-portfolio',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/night-owls-vms/kdl-portfolio",
...
#
# html_title = 'kdl-portfolio v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'This is the portfolio management for KDL students.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'kdl_portfolio'),
                os.path.join(root_path, 'kdl_portfolio/migrations')])
