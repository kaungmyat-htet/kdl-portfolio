#!/usr/bin/env python
"""
Package metadata for kdl_portfolio.
"""
import os
import re
import sys
...
VERSION = get_version('kdl_portfolio', '__init__.py')
...
setup(
    name='kdl-portfolio',
    version=VERSION,
    description="""This is the portfolio management for KDL students.""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Ted',
    author_email='kaungmyathtet.dev@gmail.com',
    url='https://github.com/night-owls-vms/kdl-portfolio',
    packages=find_packages(
        include=['kdl_portfolio', 'kdl_portfolio.*'],
        exclude=["*tests"],
    ),
    entry_points={
        'lms.djangoapp': [
            'kdl_portfolio = kdl_portfolio.apps:KdlPortfolioConfig',
        ],
    },
